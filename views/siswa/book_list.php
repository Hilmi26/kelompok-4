<!-- Zacky -->
<?php
include '../../controllers/student/function_list.php';
?>
...
<head>
    ...
    <title>Dashboard - Library Siswa</title>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">Buku /</span> List Buku
                        </h4>
                        <!-- Striped Rows -->
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="mt-2 mx-auto">
                        <nav class="mx-auto" aria-label="Page navigation example">
                            ...
                            <ul class="pagination">
                                ...
                                if ($newHalaman != 1) { ?>
                                    <li class="page-item"><a class="page-link" href="book_list.php?halaman=<?= $halaman - 1 ?>">
                                            < </a>
                                    </li>
                                    <?php }
                                for ($i = ($newHalaman - $batasHalaman); $i < ($newHalaman + $batasHalaman) + 1; $i++) {
                                    if (($i > 0) && ($i <= $total_halaman)) {
                                        ...
                                        <?php } else { ?>
                                            <li class="page-item"><a class="page-link" href="book_list.php?halaman=<?= $i ?>"><?= $i ?></a></li>
                                    <?php }
                                    }
                                }
                                if ($newHalaman != $total_halaman) { ?>
                                    <li class="page-item"><a class="page-link" href="book_list.php?halaman=<?= $newHalaman + 1 ?>"> > </a></li>
                                <?php } ?>
                            </ul>
                        </nav>
                    </div>
